    ...
    <selection id="recruiters">
        <div class="container text-center">
            ...
            <div>
                ...
                <img src ="img/boc.jpg">
                <img src ="img/combank.jpg">
                <img src ="img/damro.jpg">
                <img src ="img/dialog.jpg">
                <img src ="img/dsi.jpg">
            </div>
            <div>
                <img src ="img/hemas.jpg">
                <img src ="img/singer.jpg">
                <img src ="img/virtusa-LOGO.jpg">
                <img src ="img/slt.jpg">
                <img src ="img/ioc.jpg">
                <img src ="img/softlogic.jpg">
            </div>
        </div>
    </selection>
        ...
        <div class="container">
            ...
            <div class="campany-details">
                <div class="job-update">
                    ...
                    <i class="fa fa-briefcase"></i><span>0-1yrs</span><br>
                    <i class="fa fa-money"></i><span>rs. 40,000.00</span><br>
                    <i class="fa fa-map-marker"></i><span>colombo</span><br>
                    <p>skills <i class="fa fa-angle-double-right"></i><small>java</small><small>php</small></p>
                    <p>Description <i class="fa fa-angle-double-right"></i> mvkfdmvkkgkkvrkrlvkfklfklfkl lplgplplg<a href="#">Read more</a></p>
                </div>
                <div class="apply-btn">
